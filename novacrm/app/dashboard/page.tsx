...
export default async function DashboardPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#1e1e2e] p-8">
      <div
        className="w-full max-w-[600px] rounded-2xl border border-[#313244] bg-[#181825] p-8"
      ...
      >
        ...
        <div className="mb-6 rounded-lg border border-[#313244] bg-[#1e1e2e] p-4">
